...
def reciveMessage(clsock, clientSockets, online, accounts, msg):
    ...
    while True:
        ...
        if len(msg) == 0:
            ...
            if "get users online" == msg.decode():
...
while True:
    ...
    conn = sock.accept()##listening socket accepted
    connstream = context.wrap_socket(conn, ssl_version=ssl.PROTOCOL_TLSv1, ciphers="ADH-AES256-SHA")##create wrapped socket encrypted
